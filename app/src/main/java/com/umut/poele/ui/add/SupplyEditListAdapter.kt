...
class SupplyEditListAdapter(
    dataset: List<Supply>,
    private val vm: AddEditSupplyViewModel,
    private val forPickSupply: Boolean
) : BaseAdapter<ListEditSupplyBinding, Supply>(dataset, R.layout.list_edit_supply)
{
